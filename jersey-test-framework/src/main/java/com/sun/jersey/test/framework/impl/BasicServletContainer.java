...
/**
 * The interface which needs to be implemented by any generic container.
 * @author Naresh (Srinivas.Bhimisetty@Sun.Com)
 */
public interface BasicServletContainer extends BasicLightWeightContainer {
