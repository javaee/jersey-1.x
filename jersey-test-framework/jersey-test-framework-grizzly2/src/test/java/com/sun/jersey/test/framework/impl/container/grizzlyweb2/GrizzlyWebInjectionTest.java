...
public class GrizzlyWebInjectionTest extends JerseyTest {
        ...
        public String get() {
            ...
            if(
                    ...
                    servletConfig.getInitParameter(
                            PackagesResourceConfig.PROPERTY_PACKAGES).equals("com.sun.jersey.test.framework.impl.container.grizzlyweb2")
                    )
    ...
    public GrizzlyWebInjectionTest() {
        super(new WebAppDescriptor.Builder()
                .initParam(PackagesResourceConfig.PROPERTY_PACKAGES, "com.sun.jersey.test.framework.impl.container.grizzlyweb2").build());
    }
