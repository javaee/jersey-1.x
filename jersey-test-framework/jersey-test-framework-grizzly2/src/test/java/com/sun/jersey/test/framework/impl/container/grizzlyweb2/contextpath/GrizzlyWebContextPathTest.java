package com.sun.jersey.test.framework.impl.container.grizzlyweb2.contextpath;
...
public class GrizzlyWebContextPathTest extends JerseyTest {
    ...
    public GrizzlyWebContextPathTest() {
        super(new WebAppDescriptor.Builder("com.sun.jersey.test.framework.impl.container.grizzlyweb2.contextpath")
                .contextPath("context")
                .build());
    }
