...
public class BookmarkEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (this.bookmarkEntityPK != other.bookmarkEntityPK && (this.bookmarkEntityPK == null || !this.bookmarkEntityPK.equals(other.bookmarkEntityPK))) return false;
        return true;
    }
    ...
    public String toString() {
        return "com.sun.ws.rest.samples.bookmark.entities.BookmarkEntity[bookmarkEntityPK=" + bookmarkEntityPK + "]";
    }
