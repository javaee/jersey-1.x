...
class AtomStore {
    ...
    static void updateFeedDocument(Feed f) throws IOException {
        EntityProvider<Feed> ep = ProviderFactory.newInstance().createEntityProvider(Feed.class);
        synchronized(FileStore.FS) {
    ...
    static void createEntryDocument(String id, Entry e) throws IOException {
        EntityProvider<Entry> ep = ProviderFactory.newInstance().createEntityProvider(Entry.class);
