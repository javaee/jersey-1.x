...
/**
 * Tests the @XmlHeader annotation.
 *
 * This feature does not work with every JAXB implementation and thus is in a separate class for better build configurability.
 *
 * @author Paul Sandoz
 */
public class XmlHeaderTest extends JerseyTest {

    public XmlHeaderTest() throws Exception {
