...
public abstract class BaseResource {
     ...
     *
     * <p>FIXME - This is a pretty smelly way to transfer information from
     * an authentication filter to the corresponding request -- it would be
     * good to find something more palatable.</p>
     */
    public static ThreadLocal<User> authenticatedUserVariable = new ThreadLocal<User>();
    ...
    /**
     * <p>Injected information about the current request
     */
    ...
    /**
     * <p>Return the {@link User} instance for the authenticated user,
