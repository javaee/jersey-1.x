...
<http://code.google.com/apis/contacts/>, with some additional functionality
to illustrate alternative techniques.

The separation of functionality into three modules allows a common set of
JavaBean "model" classes to be shared by the client and server modules.

(1) ATOMPUB-CONTACTS-MODELS MODULE
...
(2) ATOMPUB-CONTACTS-SERVER MODULE
...
password combination (the database is initialized with a user named
"admin" and password "password").  The administrative user can add, update,
...
(3) ATOMPUB-CONTACTS-CLIENT MODULE
