...
public class FreemarkerTest extends JerseyTest {
    ...
    public FreemarkerTest() {
        super(new WebAppDescriptor.Builder("com.sun.jersey.samples.freemarker.resources").initParam(FreemarkerViewProcessor.FREEMARKER_TEMPLATES_BASE_PATH, "freemarker").build());
    }
