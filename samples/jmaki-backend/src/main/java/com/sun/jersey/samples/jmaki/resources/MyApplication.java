...
public class MyApplication extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        classes.add(PrintersResource.class);
        classes.add(Printer.class);
        classes.add(PrinterTableModel.class);
        classes.add(TreeModel.class);
        classes.add(WebResourceList.class);
