...
public class ServerClientMixedClientFirstTest {
    ...
    public void testSimpleResource() throws Exception {
        ...
        System.out.println("1st RESULT = " + response);
        assertEquals("raw servlet", response);

        gws.stop();

        gws = startGrizzlyWebServerWithJerseyResource();
    ...
    private GrizzlyWebServer startGrizzlyWebServerWithJerseyResource() throws IOException {
        GrizzlyWebServer gws = new GrizzlyWebServer(port);
    ...
    public static Option[] configuration() {
        ...
        Option[] options = options(
        	...
        	mavenBundle("com.sun.jersey.test.osgi.runtime-delegate-tests","runtime-delegate-test-bundle", "1.3-SNAPSHOT"),
