...
/**
 * An interface representing the OAuth signature method. Concrete
 * implementations are loaded through a service loader.
 *
...
public interface OAuthSignatureMethod {
     ...
     *
     * @param elements a {@link String} that contains the request elements to be signed.
