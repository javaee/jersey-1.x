 ...
 */
@Test
public class SpringManagedPerRequestResourceWithConstructorTest extends SpringManagedPerRequestResourceTestBase {
    
    public SpringManagedPerRequestResourceWithConstructorTest() {
        super( "managedperrequestwithconstructor" );
    }
