 ...
 */
@Test
public class SpringManagedSingletonResourceTest extends SpringManagedSingletonResourceTestBase {
    
    public SpringManagedSingletonResourceTest() {
        super( "managedsingleton" );
    }
