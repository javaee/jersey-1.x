 ...
 */
@Test
public class AutowiredBySpringSingletonResourceTest extends AutowiredSingletonResourceTestBase {
    
    public AutowiredBySpringSingletonResourceTest() {
        super( "springautowiredsingleton" );
    }
    ...
    /* (non-Javadoc)
     * @see com.sun.ws.rest.spring.AutowiredSingletonResourceTestBase#testGetAndUpdateItem()
     */
    @Test
    @Override
