...
/**
 * This is used to provide the {@link SimpleContainer} implementation when
 * the class path is scanned by the {@link ContainerFactory#createContainer(Class)}
...
public class SimpleContainerProvider implements ContainerProvider<Container> {
    ...
    public Container createContainer(Class<Container> type, 
            ResourceConfig resourceConfig, 
            WebApplication application) throws ContainerException {
        if (type != Container.class)
            return null;
        
        return new SimpleContainer(application);
    }
}
