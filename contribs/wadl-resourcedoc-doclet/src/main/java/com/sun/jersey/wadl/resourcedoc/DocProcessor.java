...
public interface DocProcessor {
     ...
     * @param classDocType the {@link ClassDocType} to extend. This will later be processed by the {@link WadlGenerator}s.
     */
     ...
     * @param paramDocType the {@link ParamDocType} to extend. This will later be processed by the {@link WadlGenerator}s.
     */
