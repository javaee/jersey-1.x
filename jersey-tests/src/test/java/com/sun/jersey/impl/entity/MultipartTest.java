 ...
 */
public class MultipartTest extends AbstractResourceTester {
    ...
    public void testFileNameInternetExplorer() throws Exception {
        initiateWebApplication(MultipartResource.class);

        WebResource r = resource("/");
        assertEquals("bhhklbpom.xml", r
                .header("Content-Type", "multipart/form-data; boundary=---------------------------7dc941520888")
                .header("User-Agent", "Mozilla/5.0 (Windows; U; MSIE 7.0; Windows NT 6.0; en-US)")
                .post(String.class, getClass().getResourceAsStream("multipart-testcase.txt")));
    }
    ...
    public void testFileName() throws Exception {
        ...
        WebResource r = resource("/");
        assertEquals("bhhklbC:javaprojectsmultipart-testcasepom.xml", r
                .header("Content-Type", "multipart/form-data; boundary=---------------------------7dc941520888")
                .post(String.class, getClass().getResourceAsStream("multipart-testcase.txt")));
    }
}
