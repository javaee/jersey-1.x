...
/**
 * A simple test case with directly references JAX-B request and response messages
 * @author Gerard Davison
 */
@Path(value = "/root")
@XmlSeeAlso(ResponseMessageSubtype.class)
public class SeeAlsoSchemaResource {
