 ...
 */
public class InheritedViewProcessorTest extends AbstractResourceTester {
    
    public InheritedViewProcessorTest(String testName) {
        super(testName);
    }
    ...
    public void testExplicitTemplate() throws IOException {
        ...
        assertEquals("/com/sun/jersey/impl/template/InheritedViewProcessorTest/ExplicitTemplateBase/show.testp", p.getProperty("path"));
        assertEquals("get", p.getProperty("model"));

        p = new Properties();
        p.load(r.path("inherit").get(InputStream.class));
        assertEquals("/com/sun/jersey/impl/template/InheritedViewProcessorTest/ExplicitTemplateBase/inherit.testp", p.getProperty("path"));
        assertEquals("get", p.getProperty("model"));

        p = new Properties();
        p.load(r.path("override").get(InputStream.class));
        assertEquals("/com/sun/jersey/impl/template/InheritedViewProcessorTest/ExplicitTemplate/override.testp", p.getProperty("path"));
        assertEquals("get", p.getProperty("model"));
    }
    ...
    public void testImplicitTemplate() throws IOException {
        ...
        Properties p = new Properties();
        p.load(r.get(InputStream.class));
        assertEquals("/com/sun/jersey/impl/template/InheritedViewProcessorTest/ImplicitTemplateBase/index.testp", p.getProperty("path"));
        assertEquals("ImplicitTemplate", p.getProperty("model"));

        p = new Properties();
        p.load(r.path("inherit").get(InputStream.class));
        assertEquals("/com/sun/jersey/impl/template/InheritedViewProcessorTest/ImplicitTemplateBase/inherit.testp", p.getProperty("path"));
        assertEquals("ImplicitTemplate", p.getProperty("model"));

        p = new Properties();
        p.load(r.path("override").get(InputStream.class));
        assertEquals("/com/sun/jersey/impl/template/InheritedViewProcessorTest/ImplicitTemplate/override.testp", p.getProperty("path"));
        assertEquals("ImplicitTemplate", p.getProperty("model"));
    }
