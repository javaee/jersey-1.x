 ...
 */
public class UriModificationFilterTest extends AbstractResourceTester {
    

    public UriModificationFilterTest(String testName) {
        super(testName);
    }
    ...
    public static class UriModifyFilter implements ContainerRequestFilter {
        public ContainerRequest filter(ContainerRequest request) {
            UriBuilder ub = request.getBaseUriBuilder();

            List<PathSegment> pss = request.getPathSegments();
    ...
    public void testWithInstance() {
        ...
        rc.getProperties().put(ResourceConfig.PROPERTY_CONTAINER_REQUEST_FILTERS,
                Arrays.asList(new UriModifyFilter()));
        initiateWebApplication(rc);

        WebResource r = resource("/a/b/c");
    }
}