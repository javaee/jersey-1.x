...
public class IntArrayTest extends AbstractResourceTester {
    public IntArrayTest(String testName) {
        super(testName);
    }

    @Path("/")
    public static class IntArrayResource {
    ...
    public void testIntArray() throws Exception {
        ResourceConfig rc = new DefaultResourceConfig(IntArrayResource.class);
        ...
        assertTrue(jsonResult.contains("[1]"));
        assertTrue(jsonResult.contains("[2]"));
    }        
}