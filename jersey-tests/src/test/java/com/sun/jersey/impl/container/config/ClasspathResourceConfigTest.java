...
public class ClasspathResourceConfigTest extends AbstractConfigTester {
    ...
    public void testTopLevel() {
        ...
        String[] paths = {"target/test-classes/com/sun/jersey/impl/container/config/toplevel"};
    ...
    public void testInnerStatic() {
        Map<String, Object> p = new HashMap<String, Object>();
        String[] paths = {"target/test-classes/com/sun/jersey/impl/container/config/innerstatic"};
        p.put(ClasspathResourceConfig.PROPERTY_CLASSPATH, paths);
        ResourceConfig rc = new ClasspathResourceConfig(p);
    ...
    public void testTopLevelInnerStatic() {
        Map<String, Object> p = new HashMap<String, Object>();
        String[] paths = {"target/test-classes/com/sun/jersey/impl/container/config/toplevelinnerstatic"};
        p.put(ClasspathResourceConfig.PROPERTY_CLASSPATH, paths);
        ResourceConfig rc = new ClasspathResourceConfig(p);
    ...
    public void testAll() {
        Map<String, Object> p = new HashMap<String, Object>();
        String[] paths = {"target/test-classes/com/sun/jersey/impl/container/config"};
        p.put(ClasspathResourceConfig.PROPERTY_CLASSPATH, paths);
        ResourceConfig rc = new ClasspathResourceConfig(p);
    ...
    public void testAllWithOnePath() {
        Map<String, Object> p = new HashMap<String, Object>();
        String paths = 
                "target/test-classes/com/sun/jersey/impl/container/config/toplevel;" +
                "target/test-classes/com/sun/jersey/impl/container/config/innerstatic;" +
                "target/test-classes/com/sun/jersey/impl/container/config/toplevelinnerstatic";
        p.put(ClasspathResourceConfig.PROPERTY_CLASSPATH, paths);
        ResourceConfig rc = new ClasspathResourceConfig(p);
    ...
    public void testJarTopLevel() throws IOException {
        File jarFile = createJarFile("target/test-classes/",
    ...
    public void testJarAzZipBoth() throws IOException {
        File zipFile = createJarFile(Suffix.zip, "target/test-classes/",
                "com/sun/jersey/impl/container/config/toplevel/PublicRootResourceClass.class",
                "com/sun/jersey/impl/container/config/toplevel/PackageRootResourceClass.class",
                "com/sun/jersey/impl/container/config/innerstatic/InnerStaticClass.class",
                "com/sun/jersey/impl/container/config/innerstatic/InnerStaticClass$PublicClass.class",
