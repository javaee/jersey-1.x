...
public class MyResourceTest extends JerseyTest {
    ...
    ClassNamesResourceConfig.class.getName()); 
        initParams.put(ClassNamesResourceConfig.PROPERTY_CLASSNAMES, "com.sun.jersey.qe.tests.core.MyResource;");
        // these work fine though
        //initParams.put(ClasspathResourceConfig.PROPERTY_CLASSPATH, ".");
        //initParams.put(PackagesResourceConfig.PROPERTY_PACKAGES, "com.sun.jersey.qe.tests.core");
