...
public class ErrorPageMappingTest extends JerseyTest {
    ...
    public ErrorPageMappingTest() throws Exception {
        super(new WebAppDescriptor.Builder("com.sun.jersey.qe.tests.errormapping")
    ...
    public void testCheckedExceptionErrorPageForMyException() {
        ...
        assertTrue("Not redirected to the CheckedException.jsp error pag",
                responseMsg.contains("Checked Exception error page"));
        assertTrue("Does not catch the expected com.sun.jersey.qe.tests.errormapping.MyResource$MyException",
                responseMsg.contains("Exception: com.sun.jersey.qe.tests.errormapping.MyResource$MyException"));
    }
    ...
    public void testCheckedExceptionErrorPageForMyMappedException() {
        ...
        assertTrue("Not redirected to the desired error page",
                responseMsg
                .contains("Jersey mapped exception: com.sun.jersey.qe.tests.errormapping.MyResource$MyMappedException"));
    }
    ...
    public void testCheckedExceptionErrorPageForMyMappedRuntimeException() {
        ...
        assertTrue("Not redirected to the desired error page",
                responseMsg
                .contains("Jersey mapped runtime exception: com.sun.jersey.qe.tests.errormapping.MyResource$MyMappedRuntimeException"));
    }
