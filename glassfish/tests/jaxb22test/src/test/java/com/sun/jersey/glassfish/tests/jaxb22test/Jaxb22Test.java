...
package com.sun.jersey.glassfish.tests.jaxb22test;
 ...
 */
public class Jaxb22Test extends JerseyTest {


    public Jaxb22Test() throws Exception {
        super(new WebAppDescriptor.Builder("com.sun.jersey.glassfish.test.jaxb22")
                .contextPath("jaxb22test").build());
    }
