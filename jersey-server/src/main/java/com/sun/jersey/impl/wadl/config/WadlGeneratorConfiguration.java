 ...
 * wadl generator decorated by other generators).<br />
 * 
 * @author <a href="mailto:martin.grotzke@freiheit.com">Martin Grotzke</a>
 * @version $Id$
 */
public interface WadlGeneratorConfiguration {

    /**
     * Returns the {@link WadlGenerator} with all decorations.
     * 
     * @return the wadlGenerator
     */
