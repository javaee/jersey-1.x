...
public class XmlTypeTest extends TestCase {
    ...
    public void testSimpleXmlTypeBean() throws Exception {
        ...
        jm.marshal(new JAXBElement<SimpleXmlTypeBean>(new QName("test"), SimpleXmlTypeBean.class, one), sw);
        ju.setJsonEnabled(true);
        two = ju.unmarshal(Stax2JsonFactory.createReader(new StringReader(sw.toString()), ctx.getJSONConfiguration(), "test"), SimpleXmlTypeBean.class).getValue();
