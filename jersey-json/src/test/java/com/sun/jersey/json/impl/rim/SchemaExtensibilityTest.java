...
import com.sun.jersey.json.impl.ResourceHelper;
...
public class SchemaExtensibilityTest extends TestCase {
    ...
    public void testExtensibility() throws Exception {
        String baseXml = ResourceHelper.getResourceAsString("com/sun/jersey/json/impl/rim/", "LightningDataset.xml");
