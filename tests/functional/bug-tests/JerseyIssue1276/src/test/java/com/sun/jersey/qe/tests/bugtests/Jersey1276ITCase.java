 ...
 */
public class Jersey1276ITCase extends JerseyTest {

    public Jersey1276ITCase() throws TestContainerException {
        super(new WebAppDescriptor.Builder(MyApplication.class.getPackage().getName()).build());
    }
