...
import com.sun.jersey.test.functional.monitoring.commons.ResourceMonitor;
...
public class WadlResourceMonitoringTest extends JerseyTest {
    ...
    public WadlResourceMonitoringTest() throws Exception {
        super(new WebAppDescriptor.Builder("com.sun.jersey.test.functional.monitoring.wadlresource")
