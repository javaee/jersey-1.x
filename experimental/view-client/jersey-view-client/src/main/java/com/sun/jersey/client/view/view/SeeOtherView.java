...
public class SeeOtherView<T> {
    ...
    public SeeOtherView(Class<T> tClass) {
        this.tClass = tClass;
    }
    ...
    @Status(303)
    @Consumes("*/*")
    public void build(String entity, @HeaderParam("Location") ViewResource locationResource) {
        this.otherResource = locationResource;
    }

    public T getOther() {
        return this.otherResource.get(tClass);
    }
}
