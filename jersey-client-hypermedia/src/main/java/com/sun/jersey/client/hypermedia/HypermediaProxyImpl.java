 ...
 */
public class HypermediaProxyImpl implements HypermediaProxy {

    public <T, R> R handleController(WebResource wr, Class<T> c, Class<R> ctlr,
            String method, Client client) throws UniformInterfaceException
    {
        ...
        return (R) Proxy.newProxyInstance(ctlr.getClassLoader(),
                new Class[] { ctlr },
                new ControllerInvocationHandler<T>(client, instance, r, ctlr));
    }
