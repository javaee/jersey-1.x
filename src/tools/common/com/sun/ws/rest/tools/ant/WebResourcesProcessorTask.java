...
package com.sun.ws.rest.tools.ant;
 ...
 */
public class WebResourcesProcessorTask extends Task {
    ...
    private Commandline setupAptForkCommand() {
        ...
        forkCmd.setClassname("com.sun.ws.rest.tools.RsGen");
        if (null != getJvmargs()) {
